...
def EDA_boxplot(df):
    ...
    # must show an error that you cannot pass more than 2 values
    if checkbox("Select to Visualize Box Plot"):
        selected_features = multiselect(
            "Select minimum two Feature", numerical_feat, key=2)
